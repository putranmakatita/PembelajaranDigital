...
public class Inbox extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private void loadMessages() {
        try {
            ...
            while (rs.next()) {
                ...
                String q2 = "SELECT fname, lname FROM Student WHERE stdID = '" + row[2] + "'";
                ResultSet rs2 = c.s.executeQuery(q2);

                String fname = "Akun", lname = "Terhapus";
                if (rs2.next()) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == replyBtn) {
            new Message(StudentLogin.currentStudentID, currentFromUserName, currentFromUserID, currentFromType);
