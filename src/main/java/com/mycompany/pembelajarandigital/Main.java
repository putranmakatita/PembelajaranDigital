...
public class Main extends JFrame implements ActionListener {
    ...
    public Main() {
        super("Aplikasi Pembelajaran Digital");
        setSize(1280, 720);
        setLocation(35, 30);
        ...
        // Header Code
        aboutProject = new JMenuItem("Tentang Aplikasi");
        aboutDevelopers = new JMenuItem("Tentang Kelompok");
        menuBar = new JMenuBar();
        about = new JMenu("Tentang");
        ...
        ImageIcon i1 = new ImageIcon(
                ClassLoader.getSystemResource("icons/MainTitle.png"));
        // ImageIcon i1 = new
        // ImageIcon(ClassLoader.getSystemResource("icons/footer.png"));
        ...
        // Main Center Code
        ImageIcon loginImg1 = new ImageIcon(
                ClassLoader.getSystemResource("icons/login.png"));
        ...
        LoginButton.setBounds(0, 0, 190, 150);
        ...
        // ImageIcon signUpImg1 = new
        // ImageIcon(ClassLoader.getSystemResource("icons/signup.png"));
        // Image signUpImg2 = signUpImg1.getImage().getScaledInstance(96, 96,
        // Image.SCALE_DEFAULT);
        // ImageIcon signUpImg3 = new ImageIcon(signUpImg2);
        // SignupButton = new JButton("Daftar", signUpImg3);
        ...
        ImageIcon mainPic1 = new ImageIcon(
                ClassLoader.getSystemResource("icons/mainBanner.jpeg"));
        Image mainPic2 = mainPic1.getImage().getScaledInstance(1280, 700, Image.SCALE_DEFAULT);
        ImageIcon mainPic3 = new ImageIcon(mainPic2);
        mainScreenLbl = new JLabel(mainPic3);
        // mainScreenLbl.setBounds(422, 50, 1280, 720);
        mainScreenLbl.setBounds(0, -150, 1280, 720);
        ...
        ImageIcon i4 = new ImageIcon(
                ClassLoader.getSystemResource("icons/footer.png"));
