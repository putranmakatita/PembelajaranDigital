...
public class LoadingScreen extends JFrame {
    ...
    JLabel backgroundPic, upperPic, textLbl, textLbl2, loadingLbl, percentageLbl;
    ...
    public LoadingScreen() {
        ...
        upperPic = new JLabel();
        upperPic.setIcon(new ImageIcon(
                ClassLoader.getSystemResource(
                        "icons/loadingIconImg.png")));
        ...
        textLbl = new JLabel("Selamat datang di");
        textLbl.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 55));
        textLbl.setForeground(Color.WHITE);
        textLbl.setBounds(350, 420, 850, 80);
        mainPanel.add(textLbl);

        textLbl2 = new JLabel("Aplikasi Pembelajaran Digital");
        textLbl2.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 55));
        textLbl2.setForeground(Color.WHITE);
        textLbl2.setBounds(245, 500, 845, 75);
        mainPanel.add(textLbl2);

        backgroundPic = new JLabel();
        backgroundPic.setIcon(
