...
import com.mycompany.pembelajarandigital.Admin.AdminLogin;
...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        title = new JLabel("Login Disini", JLabel.CENTER);
        title.setFont(title.getFont().deriveFont(22.0f));
        title.setBackground(Color.LIGHT_GRAY);
        title.setForeground(Color.BLACK);
        title.setOpaque(true);

        studentLoginButton = new JButton("Siswa Login");
        ...
        teacherLoginButton = new JButton("Guru Login");
